          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-oscuro/80">
                <p className="text-lg">
                  Soy diseñadora y desarrolladora digital nómade, creando experiencias web desde cualquier rincón del mundo.
                </p>
                <p>
                  Combino diseño minimalista con código limpio para construir proyectos que no solo se ven bien, sino que funcionan perfectamente.
                </p>
                <p>
                  Desde landings expresivas hasta invitaciones digitales personalizadas, cada proyecto es una oportunidad para innovar y crear algo único.
                </p>
              </div>
